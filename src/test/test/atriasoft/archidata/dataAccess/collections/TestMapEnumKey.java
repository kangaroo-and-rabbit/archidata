...
class TestMapEnumKey {
	...
	public static class Model {
		...
		public Long id = null;
		public Map<Enum2ForTest, String> data;
	}
	...
	void testInsertAndRetrieve() throws Exception {
		...
		test.data.put(Enum2ForTest.ENUM_VALUE_1, "hello");
		test.data.put(Enum2ForTest.ENUM_VALUE_3, "world");
	...
	void testUpdate() throws Exception {
		final Model test = new Model();
		test.data = new HashMap<>();
		test.data.put(Enum2ForTest.ENUM_VALUE_2, "foo");
		final Model inserted = ConfigureDb.da.insert(test);

		inserted.data = new HashMap<>();
		inserted.data.put(Enum2ForTest.ENUM_VALUE_4, "bar");
		inserted.data.put(Enum2ForTest.ENUM_VALUE_5, "baz");
		ConfigureDb.da.updateById(inserted, inserted.id);

		final Model retrieved = ConfigureDb.da.getById(Model.class, inserted.id);
		Assertions.assertNotNull(retrieved);
		final Map<Enum2ForTest, String> expected = new HashMap<>();
		expected.put(Enum2ForTest.ENUM_VALUE_4, "bar");
		expected.put(Enum2ForTest.ENUM_VALUE_5, "baz");
