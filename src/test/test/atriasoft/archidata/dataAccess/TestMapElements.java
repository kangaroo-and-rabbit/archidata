...
public class TestMapElements {
	private static final Logger LOGGER = LoggerFactory.getLogger(TestMapElements.class);
	...
	public void testListInteger() throws Exception {
		...
		final DataWithSubJsonMap retrieve = ConfigureDb.da.getById(DataWithSubJsonMap.class, insertedData.getOid());
