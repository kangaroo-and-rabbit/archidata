...
import test.atriasoft.archidata.dataAccess.model.TypeOneToManyDocLongParentCascadeUpdateSetNull;
import test.atriasoft.archidata.dataAccess.model.TypeOneToManyDocLongRemote;

@ExtendWith(StepwiseExtension.class)
@TestMethodOrder(MethodOrderer.OrderAnnotation.class)
class TestOneToManyCascadeUpdateSetNull {

	private static TypeOneToManyDocLongRemote insertedRemote1;
	private static TypeOneToManyDocLongRemote insertedRemote2;
	private static TypeOneToManyDocLongParentCascadeUpdateSetNull insertedParent;
	...
	void testSetup() throws Exception {
		insertedRemote1 = ConfigureDb.da.insert(new TypeOneToManyDocLongRemote("remote_cusn1", null));
