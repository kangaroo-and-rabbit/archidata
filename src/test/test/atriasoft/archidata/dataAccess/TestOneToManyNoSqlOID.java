...
import test.atriasoft.archidata.dataAccess.model.TypeOneToManyNoSqlOIDRemote;
import test.atriasoft.archidata.dataAccess.model.TypeOneToManyNoSqlOIDRoot;
import test.atriasoft.archidata.dataAccess.model.TypeOneToManyNoSqlOIDRootExpand;

@ExtendWith(StepwiseExtension.class)
@TestMethodOrder(MethodOrderer.OrderAnnotation.class)
@DisabledIfEnvironmentVariable(named = "EXCLUDE_MONGO_SPECIFIC", matches = "true")
public class TestOneToManyNoSqlOID {
	final static private Logger LOGGER = LoggerFactory.getLogger(TestOneToManyNoSqlOID.class);
	...
	public void testCreateTable() throws Exception {
		final List<String> sqlCommand = DataFactory.createTable(TypeOneToManyNoSqlOIDRemote.class);
		sqlCommand.addAll(DataFactory.createTable(TypeOneToManyNoSqlOIDRoot.class));
	...
	public void testParent() throws Exception {
		...
		final TypeOneToManyNoSqlOIDRoot root = new TypeOneToManyNoSqlOIDRoot();
		root.otherData = "plouf";
		final TypeOneToManyNoSqlOIDRoot insertedRoot = ConfigureDb.da.insert(root);
		Assertions.assertEquals(insertedRoot.otherData, root.otherData);
		Assertions.assertNull(insertedRoot.remoteIds);

		final TypeOneToManyNoSqlOIDRoot root2 = new TypeOneToManyNoSqlOIDRoot();
		root2.otherData = "plouf 2";
		final TypeOneToManyNoSqlOIDRoot insertedRoot2 = ConfigureDb.da.insert(root2);
		Assertions.assertEquals(insertedRoot2.otherData, root2.otherData);
		Assertions.assertNull(insertedRoot2.remoteIds);

		// Create Some Remotes
		final TypeOneToManyNoSqlOIDRemote remote10 = new TypeOneToManyNoSqlOIDRemote();
		remote10.data = "remote10";
		remote10.rootOid = insertedRoot.oid;
		final TypeOneToManyNoSqlOIDRemote insertedRemote10 = ConfigureDb.da.insert(remote10);
		...
		final TypeOneToManyNoSqlOIDRemote remote11 = new TypeOneToManyNoSqlOIDRemote();
		remote11.data = "remote11";
		remote11.rootOid = insertedRoot.oid;
		final TypeOneToManyNoSqlOIDRemote insertedRemote11 = ConfigureDb.da.insert(remote11);
		...
		final TypeOneToManyNoSqlOIDRemote remote20 = new TypeOneToManyNoSqlOIDRemote();
		remote20.data = "remote20";
		remote20.rootOid = insertedRoot2.oid;
		final TypeOneToManyNoSqlOIDRemote insertedRemote20 = ConfigureDb.da.insert(remote20);
		...
		final TypeOneToManyNoSqlOIDRoot retreiveRoot1 = ConfigureDb.da.get(TypeOneToManyNoSqlOIDRoot.class,
				insertedRoot.oid);
		...
		final TypeOneToManyNoSqlOIDRoot retreiveRoot2 = ConfigureDb.da.get(TypeOneToManyNoSqlOIDRoot.class,
				insertedRoot2.oid);
		...
		final TypeOneToManyNoSqlOIDRootExpand retreiveRootExpand1 = ConfigureDb.da
				.get(TypeOneToManyNoSqlOIDRootExpand.class, insertedRoot.oid);
		...
		final TypeOneToManyNoSqlOIDRootExpand retreiveRootExpand2 = ConfigureDb.da
				.get(TypeOneToManyNoSqlOIDRootExpand.class, insertedRoot2.oid);
