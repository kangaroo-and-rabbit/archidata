...
class TestSoftDelete {
	...
	@Order(2)
	@Test
	void testVerifyNotDeletedInitially() throws Exception {
	...
	@Order(3)
	@Test
	void testSoftDeleteHidesFromNormalQuery() throws Exception {
	...
	@Order(4)
	@Test
	void testSoftDeletedVisibleWithAccessDeletedItems() throws Exception {
